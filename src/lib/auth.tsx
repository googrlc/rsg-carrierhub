...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  // policies are the real enforcement; this just drives a friendly UI gate. The
  // carrier hub shares the commission app's allowlist (same Supabase project).
  ...
  return (
    <Shell>
      <div className="flex items-center gap-2.5 mb-6">
        ...
        <div>
          <h1 className="text-lg font-bold text-slate-900">RSG Carrier Hub</h1>
      ...
      <p className="mt-6 text-[11px] leading-relaxed text-slate-400">
        Access is restricted to authorized Risk Solutions Group staff. Carrier
        appointments, underwriter contacts, and portal logins are internal.
      </p>
    </Shell>
  );
}
    ...
    <Shell>
      <div className="text-center">
        ...
        <p className="mt-2 text-sm text-slate-600">
          ...
          the Carrier Hub allowlist. Ask Lamar to add you.
        </p>
        <button
          onClick={signOut}
